...
#define STRING_CONFIG_H_AUTHOR "(Minimal3DP, SKR-mini-E3-V3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 Neo v2.1.03b"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, -35, 0 }
