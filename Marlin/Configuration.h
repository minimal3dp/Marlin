...
#define STRING_CONFIG_H_AUTHOR "(wilsongis, E5P-HC-SKR2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E5P - HC SKR2 v2.1.8"
...
//#define PSU_NAME "Power Supply"
  ...
  //#define PS_OFF_SOUND            // Brom 1s when power off
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  22.9206
    #define DEFAULT_Ki  2.0177
    #define DEFAULT_Kd 65.0946
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 182.8807
  #define DEFAULT_bedKi 23.0910
  #define DEFAULT_bedKd 965.6100
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 44.5, -28.5, 0 }
